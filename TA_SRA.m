%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Auxillary Function for Systemic Asset Testing
function kstest_score = TA_SRA(SA_ticker, OA_tickers, start_date, end_date, h, iter, NJ)
