%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Conduct Tests Comparing Systemic Assets
warning('off')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Test Settings

num_tests = 250;  % Amount of test iterations

SA_tickers = {'SPY', 'IVV', 'VOO', 'VTI'};  % Systemic Assets
...
for i = 1:num_tests
    ...
    for j = 1:length(SA_tickers);
        ...
        %%%%%%%%%%%%% Randomizes the length and start of time period
        kstest_score = TA_SRA(SA_ticker, OA_tickers, start_date, end_date, h, iter, NJ);
    
    
        %%%%%%%%%%%%% Randomizes the length and start of time period
        testing_matrix(i, 3 + j) = kstest_score;
